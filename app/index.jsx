...
export default function LoginForm() {
  ...
  return (
    <SafeAreaProvider style={{ backgroundColor: "white", paddingTop: 40 }}>
      <View>
        <View style={StyleLoginForm.SectionForm}>
          <View style={{ gap: 20 }}>
            <View>
              <BlurView
                intensity={ChangesColorEmail.InputEmail.intensity}
                style={ChangesColorEmail.InputEmail}
              >
                <Image
                  source={require("../assets/IconInputs/envelope-alt (1).png")}
                  style={ChangesColorEmail.IconInputEmail}
                />
                <TextInput
                  placeholder="Email"
                  placeholderTextColor={
                    ChangesColorEmail.IconInputEmail.tintColor
                  }
            ...
            <BlurView
              intensity={ChangesColorPassword.InputPassword.intensity}
              style={ChangesColorPassword.InputPassword}
            >
              <Image
                source={require("../assets/IconInputs/lock.png")}
                style={ChangesColorPassword.IconInputPassWord}
              />
              <TextInput
                placeholder="Password"
                placeholderTextColor={
                  ChangesColorPassword.IconInputPassWord.tintColor
                }
                secureTextEntry={ShowPassword}
                style={ChangesColorPassword.TextInput_PassWord}
          ...
          <View style={CamposVacios}>
            <Text style={{ color: "#ffba08", fontWeight: "500" }}>
          ...
          <View style={{ gap: 20, paddingVertical: 30 }}>
            <View style={StyleLoginForm.ContainerBtnSignIn}>
              <TouchableOpacity
                style={StyleLoginForm.BtnSignIn}
      ...
      {/* Estabas pensando mover los modales a un documento de navegacion para mejorar la documentacion */}
      <ModalConnectRed
