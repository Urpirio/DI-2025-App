...
export default function ModalNoUsuarioNoInscrito({
  StatusModal,
  FuncionCancelar,
  Data,
  EventId,
  ...
  return (
    <Modal visible={StatusModal} transparent={true}>
      <View style={StyleModalNotInEvent.BodyContainer}>
        <View style={StyleModalNotInEvent.Blur}></View>
        <View style={StyleModalNotInEvent.MainContainer}>
          ...
          <View style={StyleModalNotInEvent.ContainerText}>
            <Text style={StyleModalNotInEvent.TextNameUser}>
              {Data ? Data.firstName + " " + Data.lastName : "No disponible"}
            </Text>
            <Text style={StyleModalNotInEvent.TextId}>
              ID: {Data ? Data.ShortID : "No disponible"}
            </Text>
          </View>
          <View style={{ gap: 10 }}>
            <TouchableOpacity
              style={StyleModalNotInEvent.btnConfirmarAsistencia}
              onPress={AsistenciaStaff}
            >
              <Text style={StyleModalNotInEvent.TextbtnConfirmarAsistencia}>
                Agregar y Confirmar Asitencia
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={StyleModalNotInEvent.BtnCancelar}
