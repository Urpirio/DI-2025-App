...
import { StyleModalParticipante } from "../../../style/Style - ScreenParticipantes/StyleModalParticipante";

export default function ModalUsuarioParticipante({
  StatusModal,
  FuncionCancelar,
  Data,
  TokenAccess,
  ...
  const ApiSpecificEvent =
    "https://directus-prueba.dominicanainnova.gob.do/items/user_event/";
      ...
      <View style={StyleModalParticipante.BodyContainer}>
        ...
        <View style={StyleModalParticipante.MainContainer}>
          ...
          <View style={StyleModalParticipante.ContainerText}>
            <Text style={StyleModalParticipante.TextNameUser}>
              {Data ? Data.firstName + " " + Data.lastName : "No disponible"}
            </Text>
            <Text style={StyleModalParticipante.TextId}>
              ID: {Data ? Data.Id : "No disponible"}
            </Text>
          </View>
          <View style={{ gap: 10 }}>
            <TouchableOpacity
              style={StyleModalParticipante.btnConfirmarAsistencia}
              onPress={() => {
                ConfirmarAsistencia();
              }}
            >
              <Text style={StyleModalParticipante.TextbtnConfirmarAsistencia}>
                Confirmar Asitencia
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={StyleModalParticipante.BtnCancelar}
              onPress={FuncionCancelar}
            >
              <Text style={StyleModalParticipante.TextBtnCancelar}>
                Cancelar
              </Text>
            </TouchableOpacity>
          </View>
