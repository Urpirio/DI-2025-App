        ...
        <View style={StyleModalPart.BodyContainer}>
          <View style={StyleModalPart.MainContainer}>
            ...
            <View style={StyleModalPart.BtnContainer}>
              <TouchableOpacity
                style={StyleModalPart.BtnRegistrar}
                onPress={FuncionOtraEntrada}
              >
                <Text style={StyleModalPart.TextBtnRegistrar}>
                  Nueva entrada
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={StyleModalPart.BtnVolver}
                onPress={FuncionVolver}
              >
                <Text style={StyleModalPart.TextBtnVolver}>
                  Volver a evento
                </Text>
              </TouchableOpacity>
            </View>
